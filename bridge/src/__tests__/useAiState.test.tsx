...
describe('useAiState', () => {
  ...
  describe('useAiState', () => {
    ...
    it('useAiState_patchEvent_updatesState', () => {
      ...
      act(() => {
        capturedHandler!(TestUtil.createPatchEvent('demo-card', 'inst-1', { title: 'AI Title' }));
      });
    ...
    it('useAiState_patchEventForDifferentInstance_ignoresEvent', () => {
      ...
      act(() => {
        capturedHandler!(
          TestUtil.createPatchEvent('demo-card', 'inst-OTHER', { title: 'Should Ignore' }),
        );
      });
    ...
    it('useAiState_snapshotEvent_replacesState', () => {
      ...
      act(() => {
        capturedHandler!(TestUtil.createPatchEvent('demo-card', 'inst-1', { title: 'Old' }));
      });
      act(() => {
        capturedHandler!(
          TestUtil.createSnapshotEvent('demo-card', 'inst-1', { title: 'Fresh', body: 'Reset' }),
        );
      });
    ...
    it('useAiState_patchEvents_mergesProps', () => {
      ...
      act(() => {
        capturedHandler!(TestUtil.createPatchEvent('demo-card', 'inst-1', { title: 'First' }));
      });
      act(() => {
        capturedHandler!(TestUtil.createPatchEvent('demo-card', 'inst-1', { body: 'Second' }));
      });
