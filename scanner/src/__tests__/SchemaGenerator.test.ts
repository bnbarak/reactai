...
describe('SchemaGenerator', () => {
  describe('generate', () => {
    ...
    it('generate_booleanProp_returnsBooleanSchema', () => {
      ...
      expect((schema.properties as Record<string, unknown>)['visible']).toEqual({ type: 'boolean' })
    })
...
const TestUtil = {
  ...
  createStringProp: (name: string): PropSpec[] => [
    { name, typeText: 'string', isOptional: false },
  ],
